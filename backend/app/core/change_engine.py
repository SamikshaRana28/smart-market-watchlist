...
# def classify_attention(attention_score: float) -> AttentionLabel:
#     """Bucket a 0–100 score into a human label (and implied color).

#     0–30 normal (green), 30–60 moderate (yellow),
#     60–80 important (orange), 80–100 significant (red).

#     Boundaries belong to the higher bucket: 30 is moderate, 60 is important,
#     80 is significant.
#     """
